...
echo "username=$username" >> ${HOME}/ArchSan/install.conf
echo "password=$password" >> ${HOME}/ArchSan/install.conf
fi
...
echo "-------------------------------------------------"
echo "       Setup Language to fr_FR and set locale       "
echo "-------------------------------------------------"
...
then
    ...
    cp -R /root/ArchSan /home/$username/
    echo "--------------------------------------"
